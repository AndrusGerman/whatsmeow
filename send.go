...
func getButtonAttributes(msg *waProto.Message) waBinary.Attrs {
	...
	case msg.ListMessage != nil:
		return waBinary.Attrs{
			"v": "2",
			// "type": strings.ToLower(waE2E.ListMessage_ListType_name[int32(msg.ListMessage.GetListType())]), // unknow
			"type": strings.ToLower(waE2E.ListMessage_ListType_name[int32(*waE2E.ListMessage_PRODUCT_LIST.Enum())]), // product list
		}
	default:
		return waBinary.Attrs{}
	}
